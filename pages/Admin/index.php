...
$query_jumlah = "SELECT COUNT(tb_dokter.id) AS jumlah FROM tb_dokter";

$result_jumlah = mysqli_query($conn, $query_jumlah);
$row_jumlah = mysqli_fetch_assoc($result_jumlah);

$query_jumlahCust = "SELECT COUNT(tb_customer.id) AS jumlahCust FROM tb_customer";

$result_jumlahCust = mysqli_query($conn, $query_jumlahCust);
$row_jumlahCust = mysqli_fetch_assoc($result_jumlahCust);
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Dokter <span>| <a
                                                href="../Transaksi/isi-biodata.php">Total</a> </span></h5>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6><?php echo $row_jumlah['jumlah'] ?></h6>Total
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card info-card customers-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6><?php echo $row_jumlahCust['jumlahCust'] ?></h6>
                                        </div>
                                    </div>
