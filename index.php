                ...
                <div class="col-12 col-md-4 col-lg-2">
                    <div class="info mt-4">
                        ...
                        <div class="footer-list mt-lg-3">
                            <li><a class="nav-footer" href="pages/Another pages/Tentang kami.php">Tentang Kami</a></li>
                            <li><a class="nav-footer" href="pages/Another pages/Hubungi kami.php">Hubungi Kami</a></li>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-2">
                    <div class="info mt-4">
                        <h3>More</h3>
                        <div class="footer-list mt-lg-3">
                            <li><a class="nav-footer" href="pages/Another pages/syarat dan ketentuan.php">Syarat & Ketentuan</a></li>
                            <li><a class="nav-footer" href="pages/Another pages/privasi.php">Privasi</a></li>
                            <li><a class="nav-footer" href="pages/FAQ/faq.php">FAQ</a></li>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-2">
